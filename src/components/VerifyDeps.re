             ...
             <Box
               ...
               <Box flexDirection="column">
                 <VerifyFilesMissingImports
                   ...
                   required={vp.packed.imports->ImportSet.keepExternalImports}
                   found={vp.pkg->Package.dependencies}
                 />
                 <VerifyFilesMissingImports
                   name="unused dependencies:"
                   required={vp.pkg->Package.dependencies}
                   found={vp.packed.imports->ImportSet.keepExternalImports}
                 />
               </Box>
             </Box>
           }
